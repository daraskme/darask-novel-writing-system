...
- 元実装: [novel-remission-online の reader/](https://github.com/daraskme/novel-remission-online/tree/9a0d01c/reader)
- 作品名と送信先の固定を外し、作品設定からの読込み、配信原稿の版記録、タブ内のトークン保存、衝突しにくい指示ファイル名、汎用ビルドを追加。
